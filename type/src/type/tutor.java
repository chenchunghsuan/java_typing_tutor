...
public class tutor {
	...
	private void initialize() {
		...
		f.setTitle("Typing Tutor");
		//Set dimensions of the frame
		f.setBounds(100, 100, 762, 620);
		//Exit on close
		...
		intructions.setBounds(21, 12, 607, 45);
		//Add JLabel to frame
		f.getContentPane().add(intructions);
		...
		f.getContentPane().add(oneButton);
		...
		//Add button to the frame
		f.getContentPane().add(twoButton);
		...
		//Add button to the frame
		f.getContentPane().add(fourButton);
		...
		//Add button to the frame
		f.getContentPane().add(fiveButton);
		...
		//Add button to the frame
		f.getContentPane().add(sixButton);
		...
		//Add button to the frame
		f.getContentPane().add(sevenButton);
		...
		//Add button to the frame
		f.getContentPane().add(eightButton);
		...
		//Add button to the frame
		f.getContentPane().add(nineButton);
		...
		//Add button to the frame
		f.getContentPane().add(zeroButton);
		...
		//Add button to the frame
		f.getContentPane().add(dashButton);
		...
		//Add button to the frame
		f.getContentPane().add(plusButton);
		...
		//Add button to the frame
		f.getContentPane().add(backspaceBtn);
		...
		//Add the button to the frame
		f.getContentPane().add(leftBracket);
		...
		//Add the button to the frame
		f.getContentPane().add(rightBracket);
		...
		//Add the button to the frame
		f.getContentPane().add(backslash);
		...
		//Add button to the frame
		f.getContentPane().add(threeButton);
